        ...
        <div class="modal-dialog" role="document" style="max-width: 800px;">
            <div class="modal-content" style="border: 3px solid black;">
                ...
                for (let material of materials) {
                    ...
                    modalHtml += `
                        <tr>
                            <td><input type="hidden" value="${material.material}"></td>
                            <td><input type="text" value="${supplier ? supplier.name : ''}"></td>
                            <td><input type="text" value="${material.units}"></td>
                            <td><input type="text" value="${supplier ? supplier.rate : ''}"></td>
                        </tr>`;
                        }
    modalHtml += `
                    </table>
